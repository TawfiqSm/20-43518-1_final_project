...
<body>
	...
	<div class="container">
<a href="http://www.dpe.gov.bd/" target="_blank"><img src="studentlogo.png" alt="" width="350px" ></a><br><hr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="studentlogo.png" width="300px" height="80px" alt=""></center>
...
<div class="form-group col-md-6">
<label for="aadharno">NID No.</label>
<input type="text" class="form-control" name="user_nid" maxlength="12" placeholder="Enter 12-digit NID no. ">
</div>
</div>
...
<label for="inputState">Zilla</label>
